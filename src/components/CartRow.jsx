     ...
     <div className="flex border-b border-gray-300 py-4 bg-white">
        <div className="w-1/2 flex">
          <div className="w-1/2 flex justify-evenly items-center">
            <button className="border border-gray-400 text-gray-400 rounded-full h-fit px-3 py-1 cursor-pointer hover:bg-gray-100 hover:text-primary">X</button>
            <img className="w-1/3" src="https://codeyogi.io/coffee-mug.jpeg"/>
          </div>
          <h4 className="self-center text-primary text-lg font-semibold">Black Printed Coffee Mug</h4>
        </div>
